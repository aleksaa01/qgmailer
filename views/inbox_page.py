...
class InboxPageView(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.list_personal = EmailListView('personal', None, parent=self.tab_personal)
        ...
        self.list_social = EmailListView('social', None, parent=self.tab_social)
        ...
        self.list_promotions = EmailListView('promotions', None, parent=self.tab_promotions)
        ...
        self.list_updates = EmailListView('updates', None, parent=self.tab_updates)
